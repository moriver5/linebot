...
class CreateLine2choicesTemplatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('line_2choices_templates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('line_2choices_templates');
    }
}
