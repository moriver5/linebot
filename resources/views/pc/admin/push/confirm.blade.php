						...
						<center>
							...
							<div>
								<div class="form-group" style="align:center;">
														...
														<tr style="text-align:center;">
															<td colspan="2">
																<div style="float:left;text-align:left;width:100%;">
																	...
																	<input type="text" id="msg{{ ($loop->index+1) }}"　name="msg{{ ($loop->index+1) }}" class="form-control" value="{{ $lines->msg }}" maxlength="60" placeholder="イチゴとスイカどちらが好きですか？">
									...
									<br />
								<form id="formCarouselSetting" class="form-horizontal" method="POST" action="/admin/member/line/setting/2choices/save/{{ $channel_id }}/send">
									{{ csrf_field() }}
