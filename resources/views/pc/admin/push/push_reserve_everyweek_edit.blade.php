        ...
        <div class="col-md-8 col-md-offset-2">
								...
								<div class="form-group" style="align:center;">
									<table border="1" width="95%">
										<tr style="text-align:center;background:wheat;font-weight:bold;">
											...
											<td>
												日曜 <input type="checkbox" id="reserve_week0" name="reserve_week" value="0" {{ $checked0 }}>　
												月曜 <input type="checkbox" id="reserve_week1" name="reserve_week" value="1" {{ $checked1 }}>　
												火曜 <input type="checkbox" id="reserve_week2" name="reserve_week" value="2" {{ $checked2 }}>　
												水曜 <input type="checkbox" id="reserve_week3" name="reserve_week" value="3" {{ $checked3 }}>
												木曜 <input type="checkbox" id="reserve_week4" name="reserve_week" value="4" {{ $checked4 }}>
												金曜 <input type="checkbox" id="reserve_week5" name="reserve_week" value="5" {{ $checked5 }}>
												土曜 <input type="checkbox" id="reserve_week6" name="reserve_week" value="6" {{ $checked6 }}>
											</td>
										</tr>
										<tr style="text-align:center;background:wheat;font-weight:bold;">
											<td>
													...
													<tr style="text-align:center;">
														...
														<table border="1" width="100%">
															<tr style="text-align:center;">
																...
																<input type="hidden" name="tmp_reserve_week" value="">
																</td>
			...
			例：11537<>52002735">{{ $lines[0] }}</textarea>
								...
								<form id="formReservePushMessage" class="form-horizontal" method="POST" action="/admin/member/line/push/message/reserve/send">
									...
									<input type="hidden" name="reserve_week" value="">
...
function Ajax2(blurId, action_url){
	...
	var reserve_week = $('[name="reserve_week"]:checked').map(function(){
		return $(this).val();
	}).get();
	$('#formLinemsg' + blurId+' [name=tmp_reserve_week]').val(reserve_week);
...
$(document).ready(function(){
	...
	$('#add_text_form').click(function(event){
		...
		$('#message_form').append('<tr style="text-align:center;"><td><form id="formLinemsg'+idNo+'" class="form-horizontal" method="POST" action="/admin/member/line/push/message/save/send"><textarea cols="50" rows="7" name="msg'+idNo+'" class="form-control" placeholder="'+idNo+'通目：LINEメッセージの内容"></textarea><input type="hidden" name="page" value="{{ $page }}"><input type="hidden" name="edit_id" value="{{ $edit_id }}"><input type="hidden" name="channel_id" value="{{ $channel_id }}"><input type="hidden" name="send_type" value="3"><input type="hidden" name="msg" value="msg'+idNo+'"><input type="hidden" name="tmp_regular_time" value="{{ $reserve_date }}"></td><td><button type="submit" id="delmsg'+idNo+'" class="btn btn-primary del_msg" style="margin:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;削除&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button><br><button type="submit" id="savemsg'+idNo+'" class="btn btn-primary save_msg" style="margin:5px;;">下書き保存</button></form></td></tr>');
...
//		event.preventDefault();
		...
		$('[name=reserve_week]').val(reserve_week);
