								...
								<div class="form-group" style="align:center;">
									...
									<table border="1" width="95%">
										<tr style="text-align:center;background:wheat;font-weight:bold;">
											...
											<td>
												<input type="text" id="reserve_date" name="tmp_reserve_date" class="form-control" value="{{ $reserve_date }}" placeholder="">
											</td>
										</tr>
									</table>
													...
													<tr style="text-align:center;">
														...
														<table border="1" width="100%">
															<tr style="text-align:center;">
																...
																<input type="hidden" name="edit_id" value="{{ $edit_id }}">
																<input type="hidden" name="tmp_reserve_date" value="{{ $reserve_date }}">
																</td>
...
function Ajax2(blurId, action_url){
	//配信予定時刻の設定
	$('#formLinemsg' + blurId+' [name=tmp_reserve_date]').val($('[name=tmp_reserve_date]').val());
...
$(document).ready(function(){
	...
	$('#add_text_form').click(function(event){
		...
		$('#message_form').append('<tr style="text-align:center;"><td><form id="formLinemsg'+idNo+'" class="form-horizontal" method="POST" action="/admin/member/line/push/message/save/send"><textarea cols="50" rows="7" name="msg'+idNo+'" class="form-control" placeholder="'+idNo+'通目：LINEメッセージの内容"></textarea><input type="hidden" name="page" value="1"><input type="hidden" name="edit_id" value="{{ $edit_id }}"><input type="hidden" name="channel_id" value="{{ $channel_id }}"><input type="hidden" name="send_type" value="1"><input type="hidden" name="msg" value="msg'+idNo+'"><input type="hidden" name="tmp_reserve_date" value="{{ $reserve_date }}"></td><td><button type="submit" id="delmsg'+idNo+'" class="btn btn-primary del_msg" style="margin:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;削除&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button><br><button type="submit" id="savemsg'+idNo+'" class="btn btn-primary save_msg" style="margin:5px;;">下書き保存</button></form></td></tr>');
